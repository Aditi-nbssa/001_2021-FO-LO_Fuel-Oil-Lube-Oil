...
lib.ssMetadata = [
		{name:"topmenu_vital_fop_atlas_1", frames: [[0,0,951,92],[0,94,158,71]]}
];
...
(lib.CachedBmp_20 = function() {
	this.initialize(ss["topmenu_vital_fop_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,475,46);
...
// stage content:
(lib.topmenu_vital_fop = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/topmenu_vital_fop_atlas_1.png", id:"topmenu_vital_fop_atlas_1"}
	],
	preloads: []
};
