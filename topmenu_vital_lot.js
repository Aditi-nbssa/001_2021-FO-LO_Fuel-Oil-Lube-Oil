...
lib.ssMetadata = [
		{name:"topmenu_vital_lot_atlas_1", frames: [[0,0,1422,92],[1424,0,158,71]]}
];
...
(lib.CachedBmp_20 = function() {
	this.initialize(ss["topmenu_vital_lot_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.topmenu_vital_lot = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/topmenu_vital_lot_atlas_1.png", id:"topmenu_vital_lot_atlas_1"}
	],
	preloads: []
};
