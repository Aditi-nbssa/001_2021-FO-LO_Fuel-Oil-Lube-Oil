...
lib.ssMetadata = [
		{name:"topmenu_vital_lot_maint_atlas_1", frames: [[0,0,1422,92],[1424,0,158,71]]}
];
...
(lib.CachedBmp_20 = function() {
	this.initialize(ss["topmenu_vital_lot_maint_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,710.2,46);
...
// stage content:
(lib.topmenu_vital_lot_maint = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.btn10.addEventListener("click", function(){
			GetUrlMain("mainmenu");
	...
	// Layer_4
	this.btn10 = new lib.button8();
	this.btn10.name = "btn10";
	this.btn10.setTransform(5,47,0.9998,1.0005);
	new cjs.ButtonHelper(this.btn10, 0, 1, 2, false, new lib.button8(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn10).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/topmenu_vital_lot_maint_atlas_1.png", id:"topmenu_vital_lot_maint_atlas_1"}
	],
	preloads: []
};
